...
define("BEFORE_PULL", "cd /var/www/thedisplay.studio/");                    // A command to execute before pulling
define("AFTER_PULL", "git reset –hard HEAD && git pull");                   // A command to execute after successfully pulling
